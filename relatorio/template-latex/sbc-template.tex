...
\begin{figure}[ht]
  \centering
  \includegraphics[width=1\textwidth]{20_entries_plot.jpg}
  \caption{20 Entradas}
  \label{fig:metodologia}
  \end{figure}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=1\textwidth]{100_entries_plot.jpg}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=1\textwidth]{250_entries_plot.jpg}
